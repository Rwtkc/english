const QUIZ_DATABASE = {
  ...
  quizData1: [
    ...
    { id: 83, word: "enact vt.", options: ["制定(法律)", "废除"], answer: 0 },
    { id: 84, word: "fluctuation n.", options: ["稳定", "波动"], answer: 1 },
    { id: 85, word: "framework n.", options: ["框架/结构", "细节"], answer: 0 },
    {
      id: 86,
      word: "incremental adj.",
      options: ["减少的", "增量的"],
      answer: 1,
    },
    {
      id: 87,
      word: "interactive adj.",
      options: ["相互作用的", "独立的"],
      answer: 0,
    },
    { id: 88, word: "misconception n.", options: ["误解", "理解"], answer: 0 },
    { id: 89, word: "module n.", options: ["整体", "单元/模块"], answer: 1 },
    {
      id: 90,
      word: "numerical adj.",
      options: ["数字的", "文字的"],
    ...
    {
      id: 91,
      word: "pre-service adj.",
      options: ["在职的", "职前的"],
      answer: 1,
    },
    { id: 92, word: "prompt vt.", options: ["促使", "抑制"], answer: 0 },
    {
      id: 93,
      word: "reconcile vt.",
      options: ["调和/使一致", "激化"],
    ...
    { id: 94, word: "sum n.", options: ["部分", "总计"], answer: 1 },
    {
      id: 95,
      word: "target vt.",
      options: ["把...作为目标", "忽视"],
    ...
    { id: 100, word: "consume vt.", options: ["生产", "消耗/吃喝"], answer: 1 },
    { id: 101, word: "contamination n.", options: ["净化", "污染"], answer: 1 },
    {
      id: 102,
    ...
    { id: 104, word: "document n.", options: ["文件/文档", "口信"], answer: 0 },
    { id: 105, word: "feed n.", options: ["饮料", "饲料"], answer: 1 },
    {
      id: 106,
      word: "horizontal adj.",
      options: ["水平的", "垂直的"],
    ...
    { id: 107, word: "immune adj.", options: ["易感的", "免疫的"], answer: 1 },
    { id: 108, word: "ingest vt.", options: ["排出", "摄入/咽下"], answer: 1 },
    {
      id: 109,
      word: "inherent adj.",
      options: ["固有的/内在的", "外在的"],
    ...
    { id: 110, word: "mate vt.", options: ["分离", "使交配"], answer: 1 },
    { id: 111, word: "mortality n.", options: ["死亡率", "出生率"], answer: 0 },
    {
      id: 112,
      word: "optimally adv.",
      options: ["最佳地", "最差地"],
    ...
    { id: 114, word: "penetrate vt.", options: ["反弹", "穿透"], answer: 1 },
    { id: 115, word: "pest n.", options: ["害虫", "益虫"], answer: 0 },
    { id: 116, word: "portion n.", options: ["一份/部分", "全部"], answer: 0 },
    {
      id: 117,
      word: "reproductive adj.",
      options: ["生殖的", "呼吸的"],
      answer: 0,
    },
    { id: 118, word: "scheme n.", options: ["巧合", "计划/方案"], answer: 1 },
    {
      id: 119,
      word: "sexual adj.",
      options: ["性的/性别的", "政治的"],
    ...
    { id: 120, word: "speculate vt.", options: ["推测", "证实"], answer: 0 },
    { id: 121, word: "substance n.", options: ["虚无", "物质"], answer: 1 },
    { id: 122, word: "trace n.", options: ["大量", "痕迹/踪迹"], answer: 1 },
    {
      id: 123,
      word: "transform vt.",
      options: ["保持", "改变/转换"],
    ...
    },
    {
      id: 125,
      word: "vitally adv.",
      options: ["无关紧要地", "极度/紧要地"],
      answer: 1,
    },
    { id: 126, word: "wean vt.", options: ["使断奶", "喂养"], answer: 0 },
    // ... Unit 4 ...
    { id: 127, word: "accord v.", options: ["给予/符合", "反对"], answer: 0 },
    { id: 128, word: "canned adj.", options: ["新鲜的", "罐装的"], answer: 1 },
    {
      id: 129,
      word: "counseling n.",
      options: ["咨询服务", "命令"],
    ...
    { id: 131, word: "duration n.", options: ["瞬间", "持续时间"], answer: 1 },
    {
      id: 132,
      word: "entertain v.",
      options: ["怀有(想法)/招待", "拒绝"],
    ...
    {
      id: 134,
      word: "metropolitan adj.",
      options: ["大城市的", "乡村的"],
      answer: 0,
    },
    { id: 135, word: "migrate v.", options: ["定居", "迁移"], answer: 1 },
    { id: 136, word: "prestige n.", options: ["声望", "耻辱"], answer: 0 },
    { id: 137, word: "prolong v.", options: ["缩短", "延长"], answer: 1 },
    {
      id: 138,
      word: "subsistence n.",
      options: ["生存/生计", "死亡"],
    ...
    { id: 139, word: "virtue n.", options: ["恶习", "美德/优点"], answer: 1 },
    // ... Unit 5 ...
    {
      id: 140,
      word: "amenable adj.",
    ...
    {
      id: 146,
      word: "overzealous adj.",
      options: ["冷漠的", "过分热心的"],
      answer: 1,
    },
    {
      id: 147,
      word: "prepublication n.",
      options: ["发表后", "发表前"],
      answer: 1,
    },
    {
    ...
    { id: 152, word: "vicinity n.", options: ["远方", "附近/邻近"], answer: 1 },
  ],
